%**********************************************************************       
%Este archivo resuelve el modelo RBC basico
%***********************************************************************
...
var YY, CC, KK, INV, HH, WP, RR, AA, GG, UU_cc;
...
%***********************************************************************
%        EQ8: DEMANDA AGREGADA
%***********************************************************************
     YY=CC+INV+GG;

%***********************************************************************
%        EQ9: DINAMICA DE LA PRODUCTIVIDAD
%***********************************************************************
    
    log(AA)=rho_aa*log(AA(-1))+ee;

%***********************************************************************
%        EQ10: DINAMICA DEL GASTO PUBLICO
%***********************************************************************
...
stoch_simul(solve_algo =1,order=1,ar=1,irf=40);
